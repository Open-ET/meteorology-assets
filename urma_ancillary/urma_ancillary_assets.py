...
PROJECT_NAME = 'openet'
ASSET_FOLDER = 'projects/openet/assets/meteorology/urma/ancillary'


def main(project_id, overwrite_flag=False):
    """Build URMA ancillary assets
    ...
    if not ee.data.getInfo(elevation_asset_id):
        ...
        export_task = ee.batch.Export.image.toAsset(
            image=elevation_img,
            description='openet_urma_elevation_asset',
    ...
    if not ee.data.getInfo(land_mask_asset_id):
        ...
        export_task = ee.batch.Export.image.toAsset(
            image=land_mask_img,
            description='openet_urma_land_mask_asset',
    ...
    if not ee.data.getInfo(latitude_asset_id):
        ...
        export_task = ee.batch.Export.image.toAsset(
            image=latitude_img,
            description='openet_urma_latitude_asset',
    ...
    if not ee.data.getInfo(longitude_asset_id):
        ...
        export_task = ee.batch.Export.image.toAsset(
            image=longitude_img,
            description='openet_urma_longitude_asset',
...
def arg_parse():
    ...
    parser = argparse.ArgumentParser(
        description='Build URMA ancillary assets',
