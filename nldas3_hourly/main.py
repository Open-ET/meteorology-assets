...
def hourly_asset_ingest(
    ...
    """Build and ingest NLDAS-3 hourly COG backed assets into Earth Engine
    ...
    # logging.info(f'  {tgt_date} - COGs uploaded to bucket')
    return f'{tgt_date} - COGs uploaded to bucket\n'
...
#         name = f'{parent}/tasks/cog_ingest_nldas3_meteorology_hourly_' \
